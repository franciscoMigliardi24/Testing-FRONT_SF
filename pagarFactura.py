...
try:
    driver.find_element_by_css_selector('tr.seleccionar-f:nth-child(2) > td:nth-child(1) > input:nth-child(1)').click()
    print('factura seleccionada')
    try:
        driver.find_element_by_xpath('/html/body/div[1]/div/div/div[2]/div[1]/div[3]/button').click()
